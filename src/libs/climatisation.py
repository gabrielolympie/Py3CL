...
class Climatisation:
    ...
    def forward(self, dpe, kwargs: ClimatisationInput):
        ...
        Rbth_j_num = dpe["Ai_frj"] + dpe["Asj"] * (
            dpe["Ai_frj"] > 0
        )  # in theory, as Ai fr is zero sur les mois de refroidissement, pas de pb
        ...
        bfroids_term2 = (
            clim["futj"] * dpe["GV"] * (dpe["Tint_froids"] - dpe["Textmoy_clim_j"]) * dpe["Nref_froids_j"] / 1000
        )
