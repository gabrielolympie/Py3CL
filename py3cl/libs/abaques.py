...
class Abaque:
    ...
    def __init__(self, config, name,data_path, **kwargs):
        """
    ...
    def forward(self, keys):
        ...
        try:
            ...
            try:
                ...
                raise ValueError(f"An error occurred while processing input {processed_input} for Abaque {self.name}. Details: {str(e)}") from None
        return result
