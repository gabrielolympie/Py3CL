    ...
    for key in input_scheme:
        if key in entangled_fields:
            ...
            if type(characteristic) == str and characteristic == "any":
                ...
                char = [elt for elt in characteristic if ((elt is not None) and (elt != "NULL") and (str(elt) != 'nan'))] + ["Unknown or Empty"]
